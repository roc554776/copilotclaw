<!-- Generated: 2026-03-27 | Updated: 2026-03-27 | Files scanned: 34 | Version: 0.22.0 | Token estimate: ~2500 -->
...
### Test Suites (228 total: 220 vitest + 8 Playwright)

```
Gateway vitest (156 tests) — unit + E2E tests with mock agent (includes config, config-cli, doctor, ipc-paths, setup, workspace, structured-logger tests)
Agent vitest (64 tests)    — unit tests with mock Copilot SDK session (includes structured-logger tests)
