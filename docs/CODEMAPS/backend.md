<!-- Generated: 2026-03-27 | Updated: 2026-03-31 | Files scanned: 44 | Version: 0.54.0 | Token estimate: ~4600 -->
...
~/.copilotclaw/                  (state dir, default profile)
  config.json                — default profile config (configVersion, port, upstream, model, otel, debug); auto-migrated on load (v4); env vars take precedence
