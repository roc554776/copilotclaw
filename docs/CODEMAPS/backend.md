<!-- Generated: 2026-03-27 | Updated: 2026-03-31 | Files scanned: 45 | Version: 0.56.0 | Token estimate: ~5000 -->
...
~/.copilotclaw/                  (state dir, default profile)
  config.json                — default profile config (configVersion, port, upstream, model, otel, debug, cron); auto-migrated on load (v5); env vars take precedence
