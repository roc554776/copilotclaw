<!-- Generated: 2026-03-27 | Updated: 2026-04-14 | Packages: 3 (cli, gateway, agent) | Version: 0.72.0 | Token estimate: ~2500 -->
...
- Test runners: vitest for unit + E2E (697 tests: 112 agent + 544 gateway + 41 frontend), Playwright for browser E2E (14 tests); gateway vitest excludes test/browser/ directory
...
- Browser E2E tests (Playwright) cover dashboard UI behaviors: processing indicator SSE hide, SSE chat update, status bar, logs panel toggle/escape, status modal, DerivedChannelStatus SSE projection (channel-status-sse.spec.ts, 3 tests), global SSE endpoint (global-sse.spec.ts, 3 tests, v0.72.0)
